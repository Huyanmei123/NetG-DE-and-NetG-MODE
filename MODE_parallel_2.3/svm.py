...
LastEditTime: 2020-12-31 11:20:48
...
def svm_train_2(train_features, train_labels, test_features, test_labels):
    ...
    pa_svm = [tpr, fpr, precission, AUC]
    time2 = time.time()
    svm_time = time2 - time1
    # print("(obj2=%.2f, tpr=recall=%.2f, fpr=%.2f, precission=%.2f, AUC=%.2f)" % (pre_tes_score, tpr, fpr, precission, AUC))
    return pre_tes_score, pa_svm, svm_time



if __name__ == "__main__":
    dim = 87
    # path1 = 'E:/MyFile/AProgram/python/workspace/the-first-topic/data/processedData/dexter_trainData.csv'
    # path2 = 'E:/MyFile/AProgram/python/workspace/the-first-topic/data/processedData/dexter_testData.csv'
    path1 = 'D:/MyFile/AProgram/workspace/the-first-topic new/data/processed-creditcard/creditcard_trainData.csv'
    path2 = 'D:/MyFile/AProgram/workspace/the-first-topic new/data/processed-creditcard/creditcard_testData.csv'
