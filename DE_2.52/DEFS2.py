...
excels_dir = utils.excels_dir
Figs_dir = utils.Figs_dir
timeEstimation_dir = utils.timeEstimation_dir
...
class DEFS:
    ...
    def execution(self, dataset):
        ...
        str1 = '{} {} weight_{} Iteration_{} N_{} rank{} {}'.format(dataset, algorithm, weight, self.Gm, self.N, rank, timestamp)
