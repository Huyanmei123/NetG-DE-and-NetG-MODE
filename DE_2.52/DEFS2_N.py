...
#%%
excels_dir = utils.excels_N_dir
timeEstimation_dir = utils.timeEstimation_N_dir
...
class DEFS:
    ...
    def execution(self, dataset):
        ...
        str1 = '{} {} weight_{} Iteration_{} N_{} rank_{} {}'.format(dataset, algorithm, weight, self.Gm, self.N, rank, timestamp)
